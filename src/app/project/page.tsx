...
const Project = () => {
  ...
  return (
    <section className="py-10 bg-gradient-to-b from-[#2b255f] to-[#020202]">
      <div className="container mx-auto text-center">
        <h2 className="text-4xl text-white font-Merienda font-bold mb-8">
          MY PROJECTS
        </h2>
          ...
          {projectList.map((project, index) => (
            ...
            >
              ...
              <a href={project.link} target="_blank" rel="noopener noreferrer">
                <button className="px-4 py-2 bg-blue-800 text-white rounded-full hover:bg-blue-600 transition duration-200">
                  View Project
                </button>
              </a>
            </div>
